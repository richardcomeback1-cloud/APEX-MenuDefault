...
(function () {
	...
	let MenuTpl = `<div id="menu_{{_namespace}}_{{_name}}" class="menu {{#align}} align-{{align}}{{/align}}">
	                    
	<div class="menu-header">{{{title}}}</div>
	
	<div class="title2">MENU SYSTEM</div>
	...
	<div class="menu-content">
		...
		<div class="menu-item {{#selected}}selected{{/selected}}">
			...
			{{#isSlider}}<div class="value">{{{sliderLabel}}}</div>{{/isSlider}}
		</div>
		{{/elements}}
	</div>
